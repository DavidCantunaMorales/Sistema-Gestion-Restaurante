        ...
        <div class="menu-bar">
            ...
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="registerUsuariosAdmin.php">
                    ...
                    <li class="nav-link">
                        <a href="registerClientesAdmin.php">
                            <i class='bx bx-body icon'></i>
                            <span class="text nav-text">Registrar Cliente</span>
                        </a>
                    </li>

                    <li class="nav-link">
                        <a href="tableUsuariosAdmin.php">
