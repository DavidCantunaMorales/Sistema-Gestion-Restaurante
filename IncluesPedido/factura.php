...
<head>
	<meta charset="UTF-8">
	<title>Factura</title>
    <link rel="stylesheet" href="../Includes/factura/style.css">
</head>
<body>
<?php echo $anulada; ?>
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. PEDIDO: <strong><?php echo $factura['ID_PEDIDO']; ?></strong></p>
				...
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							...
							<td><label>CELULAR:</label> <p><?php echo $factura['CELULAR_CLIENTE']; ?></p></td>
							<td><label>CORREO:</label> <p><?php echo $factura['CORREO_CLIENTE']; ?></p></td>
						</tr>
						<tr>
							<td><label>NOMBRE:</label> <p><?php echo $factura['NOMBRE_CLIENTE']; ?></p></td>
							<td><label>DIRECCION:</label> <p><?php echo $factura['DIRECCION_CLIENTE']; ?></p></td>
						</tr>
					</table>
				</div>
			</td>
	...
	<table id="factura_detalle">
			...
			<?php
			 ...
			 ?>
				<tr>
					<td class="textcenter"><?php echo $row['CANTIDAD_RECETA']; ?></td>
					<td><?php echo $row['NOMBRE_RECETA']; ?></td>
					<td class="textright"><?php echo $row['PRECIO_VENTAPE']; ?></td>
